  ...
  render() {
    return (
      <div className="preferencesPage">
        <Modal show={this.state.openDragHelp} onHide={() => { this.handleClose("openDragHelp") }}>
          <Modal.Header>
            <Modal.Title>What is a FR Dragon?</Modal.Title>
            <IconButton onClick={() => { this.handleClose("openDragHelp") }}>
              <CloseIcon fontSize="small" />
            </IconButton>
          </Modal.Header>

          <Modal.Body>
            <p>A Flight Rising Dragon is any of the <a href="https://www1.flightrising.com/wiki/wiki">existing breeds on Flight Rising</a>,
        ...
        <Modal show={this.state.openHumanHelp} onHide={() => { this.handleClose("openHumanHelp") }}>
          <Modal.Header>
            <Modal.Title>What is Humanoid?</Modal.Title>
            <IconButton onClick={() => { this.handleClose("openHumanHelp") }}>
              <CloseIcon fontSize="small" />
            </IconButton>
          </Modal.Header>

          <Modal.Body>
            <p>Anything with human proportions that consists primarily of human features. May contain minimal non-human/animalistic features like horns.
              <br />
              <br />
              Example:
            </p>
        ...
        <Modal show={this.state.openAnthroHelp} onHide={() => { this.handleClose("openAnthroHelp") }}>
          <Modal.Header>
            <Modal.Title>What is Anthropomorphic?</Modal.Title>
            <IconButton onClick={() => { this.handleClose("openAnthroHelp") }}>
              <CloseIcon fontSize="small" />
            </IconButton>
          </Modal.Header>

          <Modal.Body>
            <p>Anything with human proportions but consisting primarily of non-human/animalian features, usually at least the head.<br /><br />Example:
            </p>
            <img
              style={{ padding: '3%' }}
              alt="anthro example"
        ...
        <Modal show={this.state.openFeralHelp} onHide={() => { this.handleClose("openFeralHelp") }}>
          <Modal.Header>
            <Modal.Title>What is a FR Dragon?</Modal.Title>
            <IconButton onClick={() => { this.handleClose("openFeralHelp") }}>
              <CloseIcon fontSize="small" />
            </IconButton>
          </Modal.Header>

          <Modal.Body>
            <p>Anything that does not conform to human proportions (four legged, etc) and lacks human features.
        ...
        <div className="container-fluid" style={{ maxWidth: 970 + 'px' }}>
          ...
          <div style={{ marginTop: 0, marginBottom: 30, paddingTop: 0 }} className="row justify-content-center">
            <Stack spacing={1} direction={{ xs: 'column', sm: 'row' }}>
              <Chip color="primary" onClick={() => { this.handleModalClick("openDragHelp") }} icon={<HelpOutlineOutlinedIcon />} label={"FR Dragon"} />
              <Chip color="primary" onClick={() => { this.handleModalClick("openHumanHelp") }} icon={<HelpOutlineOutlinedIcon />} label={"Humanoid"} />
              <Chip color="primary" onClick={() => { this.handleModalClick("openAnthroHelp") }} icon={<HelpOutlineOutlinedIcon />} label={"Anthropomorphic"} />
              <Chip color="primary" onClick={() => { this.handleModalClick("openFeralHelp") }} icon={<HelpOutlineOutlinedIcon />} label={"Feral"} />
            </Stack>
          </div>
        </div>
        <div className="container-fluid" style={{ maxWidth: 970 + 'px' }}>
